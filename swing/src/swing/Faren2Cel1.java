...
public static void convertToCelcius()
{
	...
	double newValueToConvert = Double.parseDouble(valueToConvert.getText());
	
	result = (newValueToConvert-32.0) * (5.0/9.0);
	System.out.println("Celcius Degree: " + result);
	System.out.println(Double.parseDouble(valueToConvert.getText()));
}
